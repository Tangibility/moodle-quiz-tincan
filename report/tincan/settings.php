...
if ($hassiteconfig) {
	...
	//Add new fields for email configuration
    $page->add(new admin_setting_configtext('report_tincan/digestduration',
        get_string('digestduration', 'report_tincan'), get_string('digestduration', 'report_tincan'), '', PARAM_TEXT, 65));
 
    //Add new fields for email configuration
    $page->add(new admin_setting_configtext('report_tincan/digestaddrfrom',
        get_string('tincandigestaddrfrom', 'report_tincan'), get_string('tincandigestaddrfrom', 'report_tincan'), '', PARAM_TEXT, 65));
	
	//Add basic authorisation pass.
	$page->add(new admin_setting_configtext('report_tincan/digestaddrto',
        get_string('tincandigestaddrto', 'report_tincan'), get_string('tincandigestaddrto', 'report_tincan'), '', PARAM_TEXT, 65));	
       //  End of additional fields for email digest configuration
